export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'I’m Andrew Norell, a Tech Lead and Product Owner with a frontend dev background living in Minneapolis, MN.' },
      ...
      { property: 'og:title', content: 'Andrew Norell' },
      {
        ...
        content: 'I’m Andrew Norell, a Tech Lead and Product Owner with a frontend dev background living in Minneapolis, MN.'
      },
    ],
    link: [
